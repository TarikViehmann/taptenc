...
exes += my_benchmark
objects.my_benchmark = my_benchmark.o utils.o compact_encoder.o modular_encoder.o  encoder.o constraints.o vis_info.o xta_printer.o xml_printer.o timed_automata.o
